...
*/
//Dan East:
//This prototype does not match that found in the implmentation in m_infantry.c
//I've added an additional parameter for the vector. I also had to change the occurance
//where this func is called below.
#ifndef _WIN32_WCE
...
//Dan East:
//Need to supply a vector here to meet the corrected function prototype
#ifndef _WIN32_WCE
