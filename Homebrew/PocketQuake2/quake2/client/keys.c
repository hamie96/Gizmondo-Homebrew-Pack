...
#ifdef _WIN32_WCE
	//Dan East:
	//We need some keybindings to stick when in menus, so hardware keys can be
	//used to exit out of menus, etc.
	//This should be the record key on the various devices:
#ifdef _MIPS_
