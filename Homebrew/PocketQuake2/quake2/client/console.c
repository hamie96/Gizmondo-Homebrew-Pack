...
void Con_ToggleConsole_f (void)
{
	...
	{
#if defined(WIN32_PLATFORM_PSPC) && (_WIN32_WCE >= 300)
		//Dan East: Hide the SIP when the console is hidden
		SHSipPreference(cl_hwnd, SIP_FORCEDOWN);
#endif
		M_ForceMenuOff ();
		Cvar_Set ("paused", "0");
	}
	...
	{
#if defined(WIN32_PLATFORM_PSPC) && (_WIN32_WCE >= 300)
		//Dan East: Show the SIP when the console is brought up
		SHSipPreference(cl_hwnd, SIP_UP);
#endif
		M_ForceMenuOff ();
...
#ifdef _WIN32_WCE
	re.DrawChar (viddef.width-76+0*8, lines-12, 128+'P');
	re.DrawChar (viddef.width-76+1*8, lines-12, 128+'Q');
	re.DrawChar (viddef.width-76+2*8, lines-12, 128+'2');
#endif
